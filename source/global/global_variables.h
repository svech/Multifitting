...
public:
	...
	static double PSD_ABC_2D_nu2	   (double factor, double xi, double alpha, double nu2);
	...
	static double inheritance_Exp_Nu_2D_nu2(double alpha, double nu2);
	static double nu_Alpha_2D		   (                          double alpha, double k, double cos_Theta, double cos_Theta_0, double cos_Phi);
	static double nu2				   (										double k, double cos_Theta, double cos_Theta_0, double phi);
