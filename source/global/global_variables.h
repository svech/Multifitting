...
//	static double layer_Normalization_GSL(double thickness, QVector<Interlayer>& left_Interlayer_Composition, QVector<Interlayer>& right_Interlayer_Composition, gsl_integration_workspace* w);
	...
	static void enable_Disable_Particles_Model(Data& struct_Data, const Imperfections_Model& imperfections_Model);
	...
	static double PSD_ABC_1D_from_nu				 (double factor, double xi, double alpha, double p, gsl_spline* spline, gsl_interp_accel* acc);
	static double PSD_ABC_1D_Finite_from_nu			 (double factor, double xi, double alpha, double p, double a, gsl_spline* spline, gsl_interp_accel* acc);
	...
	static double PSD_Real_Gauss_1D_from_nu			 (double factor, double xi, double alpha, double p, gsl_spline* spline, gsl_interp_accel* acc);
	static double PSD_Real_Gauss_1D_Finite_from_nu	 (double factor, double xi, double alpha, double p, double a, gsl_spline* spline, gsl_interp_accel* acc);
	...
	static double PSD_Fractal_Gauss_1D_from_nu		 (double factor, double xi, double alpha, double p, gsl_spline* spline, gsl_interp_accel* acc);
	static double PSD_Fractal_Gauss_1D_Finite_from_nu(double factor, double xi, double alpha, double p, double a, gsl_spline* spline, gsl_interp_accel* acc);
	...
	static double ABC_1D_Integral_0_Nu				 (double sigma, double xi, double alpha, double nu, double a, ooura_fourier_sin<double>& integrator, gsl_spline* spline, gsl_interp_accel* acc, QString PSD_Model);
	static double ABC_2D_Integral_0_Nu				 (double sigma, double xi, double alpha, double nu, double a, ooura_fourier_sin<double>& integrator, gsl_spline* spline, gsl_interp_accel* acc, QString PSD_Model);
	static double FG_1D_Integral_0_Nu				 (double sigma, double xi, double alpha, double nu, double a, ooura_fourier_sin<double>& integrator, gsl_spline* spline, gsl_interp_accel* acc, QString PSD_Model);
	static double FG_2D_Integral_0_Nu				 (double sigma, double xi, double alpha, double nu, double a, ooura_fourier_sin<double>& integrator, gsl_spline* spline, gsl_interp_accel* acc, QString PSD_Model);
	static double real_Gauss_1D_Integral_0_Nu		 (double sigma, double xi, double alpha, double nu, double a, ooura_fourier_sin<double>& integrator, gsl_spline* spline, gsl_interp_accel* acc, QString PSD_Model);
	static double real_Gauss_2D_Integral_0_Nu		 (double sigma, double xi, double alpha, double nu, double a, ooura_fourier_sin<double>& integrator, gsl_spline* spline, gsl_interp_accel* acc, QString PSD_Model);
	static double integral_1D_0_p_Finite_Slit		 (double factor,double xi, double alpha, double nu, double a, ooura_fourier_sin<double>& integrator, gsl_spline* spline, gsl_interp_accel* acc, QString PSD_Model);
