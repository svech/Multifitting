...
//	}
	int index = Global_Variables::get_Index_For_Parameter_Name(struct_Data, *coupled_Parameter);
	QString full_Name = Global_Variables::parameter_Name(struct_Data, coupled_Parameter->indicator.whats_This, index);
