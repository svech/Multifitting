...
class Variable_Selection : public QDialog
{
	Q_OBJECT
public:
	explicit Variable_Selection(QTreeWidget* struct_Tree_Copy, QMap<int, QListWidgetItem*>* variables_List_Map, QListWidget* variables_List, QWidget *parent = 0);
...
public:
	...
	QMap<int, QListWidgetItem*>* variables_List_Map;
