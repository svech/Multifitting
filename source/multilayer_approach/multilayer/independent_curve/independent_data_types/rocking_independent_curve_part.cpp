...
void Rocking_Independent_Curve_Part::create_Beam_GroupBox()
{
	...
	// at fixed specular position
	{
		...
		beam_GroupBox_Layout->addWidget(at_Fixed_Specular_Position_SpinBox,1,1,Qt::AlignLeft);
		...
		beam_GroupBox_Layout->addWidget(at_Fixed_Specular_Position_Units_Label,1,2,Qt::AlignLeft);
	}
	// polarization
	{
...
void Rocking_Independent_Curve_Part::refresh_Angular_Units(bool replot)
{
	start_Argument_Spinbox->blockSignals(true);
	final_Argument_Spinbox->blockSignals(true);
...
void Rocking_Independent_Curve_Part::refresh_Spectral_Units(bool replot)
{
