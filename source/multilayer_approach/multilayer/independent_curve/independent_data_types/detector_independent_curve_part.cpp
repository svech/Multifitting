...
void Detector_Independent_Curve_Part::create_Beam_GroupBox()
{
	...
	// at fixed beam theta_0
	{
		...
		beam_GroupBox_Layout->addWidget(at_Fixed_Beam_Theta_0_Label,0,0,Qt::AlignLeft);
		...
		beam_GroupBox_Layout->addWidget(at_Fixed_Beam_Theta_0_SpinBox,0,1,Qt::AlignLeft);
		...
		beam_GroupBox_Layout->addWidget(at_Fixed_Beam_Theta_0_Units_Label,0,2,1,3,Qt::AlignLeft);
	}
	// at fixed wavelength
	{
...
void Detector_Independent_Curve_Part::create_Detector_GroupBox()
{
...
void Detector_Independent_Curve_Part::create_Footptint_GroupBox()
{
...
void Detector_Independent_Curve_Part::create_Beam_Plot()
{
...
void Detector_Independent_Curve_Part::plot_Beam_Profile()
{
	int data_Count = 301;
...
void Detector_Independent_Curve_Part::create_Sample_Plot()
{
	...
	connect(sample_Profile_CustomPlot->xAxis, static_cast<void(QCPAxis::*)(const QCPRange &)>(&QCPAxis::rangeChanged), this, &Detector_Independent_Curve_Part::auto_Replot_Curve);
	connect(sample_Profile_CustomPlot->yAxis, static_cast<void(QCPAxis::*)(const QCPRange &)>(&QCPAxis::rangeChanged), this, &Detector_Independent_Curve_Part::auto_Replot_Curve);
...
void Detector_Independent_Curve_Part::plot_Sample()
{
...
void Detector_Independent_Curve_Part::auto_Replot_Curve()
{
	double size = independent_Curve->measurement.sample_Geometry.size;
	double x_Pos = independent_Curve->measurement.sample_Geometry.x_Position;
	double z_Pos = independent_Curve->measurement.sample_Geometry.z_Position;
...
void Detector_Independent_Curve_Part::refresh_Curvature_Radius()
{
	QString R_Text;
	if(abs(independent_Curve->measurement.sample_Geometry.curvature)>CURVATURE_LIMIT)
	{
