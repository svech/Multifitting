...
void Specular_Target_Curve_Part::disable_Sampling()
{
	if(	target_Curve->measurement.argument_Type == argument_Types[Wavelength_Energy] )
	{
		target_Curve->measurement.spectral_Distribution.use_Sampling = false;
	} else
	{
		target_Curve->measurement.beam_Theta_0_Distribution.use_Sampling = false;
	}
}
